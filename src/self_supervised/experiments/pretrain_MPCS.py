...
from self_supervised.core import ssl_loss, models, pretrain, trainer_MPCS, supConLoss
...
def MPCS_Effnet_b2(data_fold, pair_sampling, LR, epoch, description, model_path=None):
    ...
    criterion = supConLoss.SupConLoss(gpu=GPU, temperature=0.1)
    epochs = no_epoch
...
if __name__ == '__main__':
    ...
    MPCS_Effnet_b2(args.data_fold, args.pair_sampling, args.LR, args.epoch, args.description, args.model_path)
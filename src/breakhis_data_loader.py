...
root = root = '/home/BreaKHis_v1/BreaKHis_v1/histology_slides/breast'
...
for fold, (train_ids, test_ids) in enumerate(data_splits):
    with open(root +f'/fold{fold}_stat.csv', 'w') as f:
        ...
        fold_path = '/home/a_shared_data/BreaKHis_v1/histology_slides/breast/folds/Fold_'+ str(fold) + '_' + str(k_folds)
        ...
        for patient in temp_patient_list_train:
            ...
            dest.append(patient)
        with open(fold_path_train +"train.txt", "w") as txt_file:
          for line in dest:
        ...
        for patient in temp_patient_list_val:
            ...
            dest.append(patient)
        with open(fold_path_val +"train.txt", "w") as txt_file:
          for line in dest:
              txt_file.write("".join(line) + "\n")
        txt_file.close()
        ...
        for patient in temp_patient_list_test:
            ...
            dest.append(patient)
        with open(fold_path_test +"train.txt", "w") as txt_file:
          for line in dest:
              txt_file.write("".join(line) + "\n")
        txt_file.close()
